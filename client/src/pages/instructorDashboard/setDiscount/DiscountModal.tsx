...
export default function DiscountModal(props:{handleClose: (() => void), id : string, updateFlag : string, updateFunc : ()=> void}) {
      ...
      <Modal.Body>
        <Formik
                  ...
                  onSubmit={async function (values){
                    ...
                    //alert(URL);
                    if(props.updateFlag == ''){
                    await axios.post(`${APP_BASE_API_URL}/courses/${props.id}/discount`, {startDate: startDatee
                  ,endDate: De, percentage: per})
                      ...
                      await axios.patch(`${APP_BASE_API_URL}/courses/${props.id}/discount/${props.updateFlag}`, toBeUpdated)
                      .then(_response => {
...
<Input
        ...
        <button type='submit' style={{backgroundColor:'#A00407', color:'white', marginLeft:'80%'}}>
          Submit
        </button>
