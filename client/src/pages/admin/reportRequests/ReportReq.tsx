  ...
  return (
    ...
    {({ placement, arrowProps, show: _show, popper, ...props }) => (
      ...
      style={{
        ...
        <button style={{display:'block'}} type='button' onClick={() => applyAll(Status.RESOLVED)}>Accept all</button>
        <button type = 'button' onClick={()=> applyAll(Status.REJECTED)}>Reject all</button>
      </div>
      )}
    </Overlay>
    </div>
