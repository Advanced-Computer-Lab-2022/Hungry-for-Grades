    ...
    <div style={{width:'100%', backgroundColor:'#112D4E'}}>
        <div className="container-lg" style={{width:'100%', backgroundColor:'#112D4E', alignItems:'center'}}>
            ...
            <div className="d-flex justify-content-between" style={{alignItems:'center'}}>
                <span style= {{color:'#F9F7F7', fontSize:'1.7rem', fontWeight:'350'}}>Admin Dashboard</span>
            </div>
            <br />

            <Nav defaultActiveKey="/home" variant = "pills">
                <Nav.Item>
                    <NavLink className={`nav-link ${currentPath === '/admin/addadmin' ? 'active' : ''}`} to='/admin/addadmin'  ><span className = {styles.dashhero}>Add new Admin </span></NavLink>
                </Nav.Item>
                <Nav.Item>
