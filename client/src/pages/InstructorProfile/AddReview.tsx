...
export default function AddReview(props : {isUpdating : boolean, instructorID : string, updateFunction : ()=>void}) {
  ...
  async function handleSubmit()
  {
    ...
    if(!props?.isUpdating)
    {
        ...
        rev.URL = `/instructor/rating/${props?.instructorID}/trainee/${user?._id as string}`
