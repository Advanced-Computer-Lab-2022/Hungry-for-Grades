		...
		<div className="overlay__content">
			<div className="overlay__content__header">
				...
				<div className="overlay__content__header__rating">
					<span className="overlay__content__header__rating__number">4.5</span>
			...
			<div className="overlay__content__body">
				<div className="overlay__content__body__instructors">
					<span className="overlay__content__body__instructors__label">Instructors:</span>
					<span className="overlay__content__body__instructors__value">Instructor 1, Instructor 2</span>
				</div>
				<div className="overlay__content__body__duration">
					<span className="overlay__content__body__duration__label">Duration:</span>
